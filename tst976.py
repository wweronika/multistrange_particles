#this file will hopefully have some useful stuff in the future :')
#accidentally added this into the main branch??
#update: editted version of Dominick's file that shows you the removed data instead:

##Dominic Herd's code, bless that dude
##Date: 08/02/2021
...
while True:    
    ...
    if type(lowerLim) != str:       #cuts the part after ther lower lim  -TS
        x = 0
    ...
    if type(UpperLim) != str:  #cuts the part smaller than upperlim but larger than lowerlim -TS
        x = 0
        while x < len(RealXiData):
