...
# LEWIS EDIT: significance plot prints value and location of maximum significance (line 408 approx.)
...
while vChoice != "0":
   ...
   # choice  6
        ...
        plt.legend()
        plt.show()
        # print maximum significance location
        max_sig = np.max(signif)
        max_x = cutPoints[signif.argmax()]  
        print("Maximum significance is sig={}".format(max_sig))
        print("This is found at: x={}".format(max_x))
