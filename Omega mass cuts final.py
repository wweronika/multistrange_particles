...
def ximass_correct(columns):
    return not (columns[2] > 1.323 and columns[2] < 1.34) and columns[2] <1.5 and columns[2] >1.28
def vmass_correct(columns):
  return columns[3] > 1.1125 and columns[3] < 1.122

def v0radius_correct(columns):
  return columns[4] > 0 and columns[4] < 50
...
def v0cos_correct(columns):
  return columns[7] > 0.9985

def dcaneg_correct(columns):
  return columns[8] > 0 and columns[8] < 4

def dcapos_correct(columns):
  return columns[9] > 0 and columns[9] < 2
...
def nsigpion_correct(columns):
  return columns[15] > -5 and columns[15] < 5

def nsigproton_correct(columns):
  return columns[16] > -3 and columns[16] < 3
