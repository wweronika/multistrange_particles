...
########################################
def noGraphFit(RealXiDataClone, bounds = ([2,1.66,0,-5,-30,0,0], [25,1.68,0.01,10,5,200,500]), Bins = 50, Range = [1.6,1.825]):
...
def gPlusPolyFit(data, Bounds = ([2,1.66,0,-5,-30,0,0], [25,1.68,0.01,10,5,200,500]), Column = 1, Bins = 50, Range = [1.6,1.75]):
