...
def soloPlot():
    ...
    plt.hist(RealXiData[:,1], bins = 200, label='Real Omega') #, range = Range)
    yText = "Counts"
...
########################################
def noGraphFit(RealXiDataClone, bounds = ([30,1.31,0,-5,-30,0,0], [150,1.34,0.01,10,5,200,500]), Bins = 200, Range = [1.28,1.55]):
...
def gPlusPolyFit(data, Bounds = ([30,1.31,0,-5,-30,0,0], [150,1.34,0.01,10,5,200,500]), Column = 1, Bins = 200, Range = [1.28,1.55]):
