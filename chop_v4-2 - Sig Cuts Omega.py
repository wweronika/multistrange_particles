...
########################################
def noGraphFit(RealXiDataClone, bounds = ([5,1.665,0,-5,-30,0,0], [30,1.675,0.01,10,5,200,500]), Bins = 50, Range = [1.6,1.825]):
...
def gPlusPolyFit(data, Bounds = ([5,1.665,0,-5,-30,0,0], [30,1.675,0.01,10,5,200,500]), Column = 1, Bins = 50, Range = [1.6,1.75]):
...
while vChoice != "0":
    ...
    # choice  4
        ...
        (fit) = gPlusPolyFit(RealXiData, Range = [min(RealXiData[:,1]),1.75])
        print("Mean: ",fit[1])
